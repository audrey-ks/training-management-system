...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ECA CONSEILS'); ?> — ECA CONSEILS</title>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <img src="<?php echo e(asset('eca.png')); ?>" alt="ECA CONSEILS">
        <div style="display:none; align-items:center; gap:.6rem;">
            <i class="fa-solid fa-graduation-cap"></i>
            <span>ECA CONSEILS</span>
        </div>
        <span class="badge-role ms-auto"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
    </div>
    <nav class="sidebar-nav">
        ...
        <?php elseif(auth()->user()->isTrainer()): ?>
            <span class="sidebar-section">Main</span>
            <a href="<?php echo e(route('trainer.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('trainer.dashboard') ? 'active' : ''); ?>">
                <i class="fa-solid fa-gauge"></i> Dashboard
            </a>

        <?php elseif(auth()->user()->isTrainee()): ?>
            <span class="sidebar-section">Main</span>
            <a href="<?php echo e(route('trainee.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('trainee.dashboard') ? 'active' : ''); ?>">
                <i class="fa-solid fa-gauge"></i> Dashboard
            </a>
            <a href="<?php echo e(route('trainee.sessions.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('trainee.sessions.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-book-open"></i> Browse Sessions
            </a>
        <?php endif; ?>

        <span class="sidebar-section">Account</span>
            <a href="<?php echo e(route('settings.edit')); ?>" class="sidebar-link <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>">
...
<div class="main-wrapper">
    <div class="topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <img src="<?php echo e(auth()->user()->avatar_url); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="rounded-circle" style="width:34px;height:34px; object-fit: cover;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
...
<?php /**PATH C:\xampp\htdocs\tms\resources\views/layouts/app.blade.php ENDPATH**/ ?>